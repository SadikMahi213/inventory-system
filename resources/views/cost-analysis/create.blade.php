...
@section('title', 'Add Cost Analysis')

@section('content')
<div class="container mx-auto px-4">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-bold">Add Cost Analysis</h1>
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        <form action="{{ route('cost-analysis.store') }}" method="POST">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="purchase_record_id" id="purchase_record_id" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                        ...
                        @foreach($purchaseRecords as $purchase)
                            <option value="{{ $purchase->id }}" {{ old('purchase_record_id') == $purchase->id ? 'selected' : '' }}>
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="number" step="0.01" name="final_selling_price" id="final_selling_price" value="{{ old('final_selling_price') }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                </div>
            </div>
